const I18N = {
    vi: {
        ...
        /* ── Defect Report page ── */
        'dr.title.short'       : 'Báo Cáo Tỷ Lệ Đạt',
        'dr.page.title'        : 'Yield Report — Báo Cáo Tỷ Lệ Lỗi & Tỷ Lệ Đạt',
        'dr.page.subtitle'     : 'Phân tích tỷ lệ lỗi và tỷ lệ đạt theo công đoạn, lớp phủ và mã sản phẩm.',
        'dr.filter.title'      : '🔎 Bộ lọc dữ liệu',
        'dr.label.from'        : '📅 Từ ngày',
        'dr.label.to'          : '📅 Đến ngày',
        'dr.label.process'     : '⚙️ Công đoạn',
        'dr.label.coating'     : '🎨 Lớp phủ',
        'dr.label.partcode'    : '🔩 Mã linh kiện',
        'dr.label.product'     : '📦 Sản phẩm',
        'dr.all.process'       : '-- Tất cả công đoạn --',
        'dr.all.coating'       : '-- Tất cả lớp phủ --',
        'dr.all.partcode'      : '-- Tất cả mã --',
        'dr.all.product'       : '-- Tất cả sản phẩm --',
        'dr.btn.apply'         : 'Áp dụng',
        'dr.btn.reset'         : 'Đặt lại',
        'dr.btn.excel'         : 'Xuất Excel',
        'dr.kpi.input.label'   : 'Tổng SL đầu vào',
        'dr.kpi.input.sub'     : 'Số lượng đầu vào',
        'dr.kpi.ng.label'      : 'Tổng SL lỗi (NG)',
        'dr.kpi.ng.sub'        : 'Số lượng không đạt',
        'dr.kpi.defrate.label' : 'Tỷ lệ lỗi',
        'dr.kpi.defrate.sub'   : 'Tổng tỷ lệ lỗi',
        'dr.kpi.yield.label'   : 'Tỷ lệ đạt',
        'dr.kpi.yield.sub'     : 'Tổng tỷ lệ đạt',
        'dr.chart.trend'       : 'Xu hướng tỷ lệ lỗi theo ngày',
        'dr.chart.defects'     : 'Top loại lỗi',
        'dr.chart.process'     : 'Tỷ lệ lỗi theo công đoạn',
        'dr.table.title'       : 'Chi tiết tỷ lệ lỗi theo sản phẩm & công đoạn',
        'dr.loading'           : 'Đang tải dữ liệu...',
        'dr.empty.init'        : 'Chọn bộ lọc và nhấn Áp dụng để tải dữ liệu.',
        'dr.empty.nodata'      : 'Không có dữ liệu trong khoảng thời gian đã chọn.',
        'dr.total.label'       : 'TỔNG',
    ...
    en: {
        ...
        /* ── Defect Report page ── */
        'dr.title.short'       : 'Defect Report',
        'dr.page.title'        : 'Yield Report — Yield & NG Analysis',
        'dr.page.subtitle'     : 'Analyze defect rate and yield rate by process, coating and product code.',
        'dr.filter.title'      : '🔎 Filters',
        'dr.label.from'        : '📅 From Date',
        'dr.label.to'          : '📅 To Date',
        'dr.label.process'     : '⚙️ Process',
        'dr.label.coating'     : '🎨 Coating',
        'dr.label.partcode'    : '🔩 Part Code',
        'dr.label.product'     : '📦 Product',
        'dr.all.process'       : '-- All Process --',
        'dr.all.coating'       : '-- All Coatings --',
        'dr.all.partcode'      : '-- All Part Codes --',
        'dr.all.product'       : '-- All Products --',
        'dr.btn.apply'         : 'Apply',
        'dr.btn.reset'         : 'Reset',
        'dr.btn.excel'         : 'Export Excel',
        'dr.kpi.input.label'   : 'Total Input Qty',
        'dr.kpi.input.sub'     : 'Total Input Quantity',
        'dr.kpi.ng.label'      : 'Total NG Qty',
        'dr.kpi.ng.sub'        : 'Total Non-Good Quantity',
        'dr.kpi.defrate.label' : 'Defect Rate',
        'dr.kpi.defrate.sub'   : 'Overall Defect Rate',
        'dr.kpi.yield.label'   : 'Yield Rate',
        'dr.kpi.yield.sub'     : 'Overall Yield Rate',
        'dr.chart.trend'       : 'Defect Rate Trend by Date',
        'dr.chart.defects'     : 'Top Defect Types',
        'dr.chart.process'     : 'Defect Rate by Process',
        'dr.table.title'       : 'Defect Detail by Product & Process',
        'dr.loading'           : 'Loading data...',
        'dr.empty.init'        : 'Select filters and click Apply to load data.',
        'dr.empty.nodata'      : 'No data found for the selected period.',
        'dr.total.label'       : 'TOTAL',
        'dr.export.ok'         : 'Exported {n} rows to Excel.',
        'dr.export.nodata'     : 'No data to export.',
        'dr.pg.showing'        : 'Showing {from}–{to} of {total} rows',
    }
};
